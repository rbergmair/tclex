...
def en_adv_bymeta( enwiktionary_en_word_bymeta_fn, out_fn ):
...
def en_adv_irregular_bycontent( enwiktionary_en_adv_irregular_fn, out_fn ):

  w = 0;

  with open( enwiktionary_en_adv_irregular_fn, "rt" ) as inf:
...
def en_adv_regular_bycontent( enwiktionary_en_adv_regular_fn, out_fn ):

  w = 0;

  with open( enwiktionary_en_adv_regular_fn, "rt" ) as inf:
